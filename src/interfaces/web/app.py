...
from src.application.services.fountain_service import fountain_service
...
def serve_media(filename):
    media_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../infrastructure/assets/media"))
    return send_from_directory(media_dir, filename)

@app.route('/audio/<path:filename>')
def serve_audio(filename):
    audio_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../infrastructure/assets/audio"))
