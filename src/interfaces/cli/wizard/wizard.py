...
class Wizard:
    ...
    def __init__(self, user_instance):
        ...
        self.packages_dir = Path(__file__).parent.parent.parent.parent / "infrastructure" / "data" / "packages"
    ...
    def attribute_templates(self):
        ...
        while True:
            if not self.available_templates:
                ui.show_list(["No templates found in infrastructure/data/packages/"], "ATTRIBUTE TEMPLATES")
                return
