...
SINGLE_COMMANDS = {
    ...
    "94": {"len": 0, "func": user.list_sequences, "label": "list_sequences"},
    ...
    "994": {"len": 0, "func": user.list_sequences_detailed, "label": "list_sequences_detailed"},
    "999": {"len": 0, "func": user.show_object_tree, "label": "object_tree"},
...
COMMANDS = {
    ...
    "delete sequence": {"func": user.delete_sequence},
    "sequence add action": {"func": user.sequence_add_action},
